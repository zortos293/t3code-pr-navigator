...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col">
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 bg-white px-4 py-2 shrink-0 dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="flex flex-1 min-h-0">
        <aside className="w-72 border-r border-gray-200 bg-white flex flex-col shrink-0 dark:border-gray-800 dark:bg-gray-900">
